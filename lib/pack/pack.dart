...
/// Convert list of maps to a packed map structure:
/// `{ "columns": ["column1", "column2"], "rows": [["row1_col1", "row1_col2"], ["row2_col1", "row2_col2"]] }`
...
/// Convert packed map structure back to list of maps:
/// `{ "columns": ["column1", "column2"], "rows": [["row1_col1", "row1_col2"], ["row2_col1", "row2_col2"]] }`
