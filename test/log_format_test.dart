...
void main() {
  group('log_format', () {
    ...
    test('logFormatConvert with depth', () {
      expect(
        logFormatConvert(null, options: const LogFormatOptions(depth: 0)),
        isNull,
      );
      expect(logFormatConvert(1, options: const LogFormatOptions(depth: 0)), 1);
      expect(
        logFormatConvert(null, options: const LogFormatOptions(depth: 1)),
        isNull,
      );
      expect(
        logFormatConvert(newModel(), options: const LogFormatOptions(depth: 0)),
        _unknownMap,
      );
      expect(
        logFormatConvert({
      ...
      expect(
        logFormatConvert([], options: const LogFormatOptions(depth: 0)),
        _unknownList,
      );
      expect(
        logFormatConvert([
      ...
      expect(
        logFormatConvert(map2, options: const LogFormatOptions(depth: 0)),
        {'.': '.'},
      );
      expect(
        logFormatConvert(list2, options: const LogFormatOptions(depth: 0)),
        ['..'],
      );
      expect(
      ...
      expect(
        logFormat(list2, options: const LogFormatOptions(depth: 4)),
      ...
      expect(
        logFormat(list2, options: const LogFormatOptions(depth: 1)),
        '[[..], {.: .}]',
      );
      expect(
        logFormat(map2, options: const LogFormatOptions(depth: 3)),
        '{map1: {int: 1, string: text}, list1: [1, test, null, 1.1, {int: 1, string: text}]}',
      );
      expect(
        logFormat(map2, options: const LogFormatOptions(depth: 2)),
        '{map1: {int: 1, string: text}, list1: [1, test, null, 1.1, {.: .}]}',
      );
      expect(
        logFormat(map2, options: const LogFormatOptions(depth: 1)),
        '{map1: {.: .}, list1: [..]}',
      );
    });
