...
void main() {
  group('Subject', () {
    ...
    test('can synchronously get the latest value', () async {
      // ignore: close_sinks
      final Subject<int> subject = new Subject<int>();
    ...
    test('can synchronously get the initial value', () {
      // ignore: close_sinks
      final Subject<int> subject = new Subject<int>(value: 1);
    ...
    test('replays the previously emitted items from addStream', () async {
      // ignore: close_sinks
      final StreamController<int> subject = new Subject<int>();
    ...
    test('returns onListen callback set in constructor', () async {
      ...
      final StreamController<int> subject =
          new Subject<int>(onListen: testOnListen);
    ...
    test('returns onCancel callback set in constructor', () async {
      ...
      // ignore: close_sinks
      final StreamController<int> subject =
          new Subject<int>(onCancel: onCancel);
    ...
    test('can be listened to multiple times', () async {
      // ignore: close_sinks
      final StreamController<int> subject = new Subject<int>(value: 1);
