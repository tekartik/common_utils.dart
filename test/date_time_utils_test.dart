...
void main() {
  group('date_time_utils', () {
    test('withOffset', () {
      DateTime dateTime = DateTime.utc(2018, 1, 25, 1);
      DateTime dateTime2 = DateTime.utc(2018, 1, 25, 2);
      expect(dateTimeWithOffset(dateTime, hourInMillis), dateTime2);
    });

    test('dateTimeWithTimeCleared', () {
      DateTime dateTime = DateTime.utc(2018, 1, 25, 1, 2, 3, 4, 5);
      DateTime dateTime2 = DateTime.utc(2018, 1, 25);
    ...
    test("dateTimeFromInt", () {
      ...
      expect(DateTime.fromMillisecondsSinceEpoch(0, isUtc: true),
          dateTimeFromInt(0));
